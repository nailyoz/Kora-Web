...
export function PaginaBemVindo(props) {
  return (
    <Root>
      <Header>
        <img alt="Kora-mark" src={marca} height="40px"></img>
      ...
      <Neck>
        <img
          ...
          src={
            "https://i.ibb.co/K7kgrdk/High-above-Young-and-graceful-ballet-dancer-on-pink-studio-background-in-neon-light-Art-motion-actio.jpg"
          }
          height="450px"
          width="100%"
        ></img>
      ...
      <Body>
        <Container>
          <img
            ...
            alt="Imagem de dança"
            src={
              "https://i.ibb.co/B2xWv28/Dance-time-Stylish-men-and-woman-dancing-hip-hop-in-bright-clothes-on-green-background-at-dance-hall.jpg"
            }
          ></img>
          <div
            style={{
          ...
          <img
            ...
            alt="Imagem de dança"
            src={
              "https://i.ibb.co/L6GXQPZ/Young-beautiful-man-and-woman-dancing-hip-hop-street-style-isolated-on-studio-background-in-colorful.jpg"
            }
          ></img>
          ...
          >
            <img
              ...
              alt="Imagem de dança"
              src={
                "https://i.ibb.co/GC15Jg1/Beautiful-sportive-girls-dancing-hip-hop-in-stylish-clothes-on-colorful-gradient-studio-background-i.jpg"
              }
            ></img>
            <Typography
              variant="h5"
              sx={{ fontSize: "16px", fontFamily: "Outfit" }}
            >
          ...
          <Stack spacing={8} direction="row">
            ...
            <Item>
              ...
              <RoundedChip
                ...
                imgSource={"https://i.ibb.co/R4DCsWJ/Design-sem-nome.png"}
              />
            </Item>
          </Stack>
        </Belly>
